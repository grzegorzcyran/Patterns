package grcy.sda.patterns;

import sda.patterns.behavioral.chainOfResponsibility.*;
import sda.patterns.behavioral.command.CreateFileOperation;
import sda.patterns.behavioral.command.FileOperationPerformer;
import sda.patterns.behavioral.command.MyFile;
import sda.patterns.behavioral.command.UpdateFileOperation;
import sda.patterns.behavioral.iterator.MyIterator;
import sda.patterns.behavioral.iterator.Payment;
import sda.patterns.behavioral.iterator.PaymentList;
import sda.patterns.behavioral.mediator.AllegroCustomer;
import sda.patterns.behavioral.mediator.AllegroMediator;
import sda.patterns.behavioral.mediator.Customer;
import sda.patterns.behavioral.mediator.Mediator;
import sda.patterns.behavioral.memento.GameState;
import sda.patterns.behavioral.memento.GameStateMemento;
import sda.patterns.behavioral.state.Flight;
import sda.patterns.behavioral.strategy.CarStrategy;
import sda.patterns.behavioral.strategy.Travel;
import sda.patterns.behavioral.strategy.WalkStrategy;
import sda.patterns.behavioral.visitor.*;
import sda.patterns.creational.abstractFactory.Object1Factory;
import sda.patterns.creational.abstractFactory.ObjectFactory;
import sda.patterns.creational.prototype.ShoppingList;
import sda.patterns.creational.singleton.EagerSingleton;
import sda.patterns.creational.singleton.LazySingleton;
import sda.patterns.structural.decorator.BasicItem;
import sda.patterns.structural.decorator.Item;
import sda.patterns.structural.decorator.SpecialItem1;
import sda.patterns.structural.decorator.SpecialItem2;
import sda.patterns.structural.flyweight.FordMustang;
import sda.patterns.structural.proxy.CompanyEmployees;
import sda.patterns.structural.proxy.CompanyInternetNetwork;
import sda.patterns.structural.proxy.ProxyCompanyInternetAccess;
...
*/
	private static void testAbstractFactory(){
		sda.patterns.creational.abstractFactory.ObjectType
				object1 =  ObjectFactory.getObject(
						new Object1Factory("Object1", "Value1", 1)) ;

		sda.patterns.creational.abstractFactory.ObjectType object2 =  ObjectFactory.getObject(new Object1Factory("Object2", "Value2", 2)) ;
	...
	private static void testBuilder(){
		...
		sda.patterns.creational.builder.Object object =
				new sda.patterns.creational.builder.Object.ObjectBuilder
